...
Namespace InventorAddIninVB
    <ProgIdAttribute("InventorAddIninVB.StandardAddInServer"), _
    GuidAttribute("cbd9656c-abaf-4340-a40a-c2487badcaf5")> _
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(InventorAddIninVB.StandardAddInServer)
